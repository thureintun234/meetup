...
module.exports = (config) => {
  ...
  app.use(session({
    ...
    store: new MongoDBStore({ uri: process.env.DEVELOPMENT_DB_DSN, collection: 'mySessions' })
  }))
  ...
  if (app.get('env') === 'development') {
    ...
    app.use(session({
      ...
      resave: true,
      saveUninitialized: false,
      store: new MongoDBStore({ uri: process.env.DEVELOPMENT_DB_DSN, collection: 'sessionId' })
    }))
  }
